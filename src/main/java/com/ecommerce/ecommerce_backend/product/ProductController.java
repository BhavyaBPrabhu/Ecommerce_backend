...
public class ProductController {
		...
		@Operation(
		        ...
		        description = "Fetches paginated list of products as per the search criteria"
		    )
		@GetMapping("/search")
		...
		@Operation(
		        summary = "Get all products",
		        description = "Fetches the product based on the product id"
		    )
		@GetMapping("/{id}")
	    ...
	    @Operation(
	        ...
	        description = "Creates a product under a category. Admin access only.",
	    ...
	    @Operation(
	    	    ...
	    	    description = "Updates an existing product by ID. Admin access only.",
	    	    security = @SecurityRequirement(name = "bearerAuth")
	    	)
	    	@ApiResponses({
